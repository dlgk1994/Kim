...
<div class="wrap">
	...
	<form action="${contextPath }/adminProduct/adminProductModify?productNum=${productView.productNum}" method="post" enctype="multipart/form-data">
		...
		<div class="button">
			...
			<input type="button" class="btn btn-outline-primary" id="cancel" onclick="location.href='${contextPath}/adminProduct/delete?${productView.productNum}&productThumbnail=${productView.productThumbnail }'" value="삭제">
